...
import { CustomSelect, GridCustom, GridSelect } from '../../styles/layout/Layout.styled'
...
const FooterContent = () => {
  ...
  return (
    <Grid container spacing={2} sx={{ position: 'fixed', bottom: '10px', right: '10px' }}>
      <Grid item xs={7} md={10.5} display='flex'>
        <Typography variant='h6' display='flex' alignItems='center' sx={{ marginLeft: 'auto' }}>
